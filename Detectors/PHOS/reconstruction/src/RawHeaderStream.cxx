...
std::istream& o2::phos::operator>>(std::istream& stream, o2::header::RAWDataHeaderV4& header)
{
...
std::istream& o2::phos::operator>>(std::istream& stream, o2::header::RAWDataHeaderV5& header)
{
  // std::cout << "called, 10 words" << std::endl;
  using wordtype = uint64_t;
  constexpr int RAWHEADERWORDS = sizeof(header) / sizeof(wordtype);
...
std::ostream& o2::phos::operator<<(std::ostream& stream, const o2::header::RAWDataHeaderV4& header)
{
...
std::ostream& o2::phos::operator<<(std::ostream& stream, const o2::header::RAWDataHeaderV5& header)
{
