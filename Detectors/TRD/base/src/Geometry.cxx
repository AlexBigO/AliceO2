...
void Geometry::fillMatrixCache(int mask)
{
  ...
  if (mask & o2::math_utils::bit2Mask(o2::math_utils::TransformType::L2G)) {
    useL2GCache();
  }
  if (mask & o2::math_utils::bit2Mask(o2::math_utils::TransformType::T2G)) {
    useT2GCache();
  }
  if (mask & o2::math_utils::bit2Mask(o2::math_utils::TransformType::T2GRot)) {
    useT2GRotCache();
  }
